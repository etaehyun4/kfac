...
<form name="fwrite" method="post" action="./write_update.php" enctype="multipart/form-data" style="margin:0px;" onsubmit="return set_menu('loading')" >
