...
<tr bgcolor="#F8F8F9"><td colspan=2>
    ...
    <span style="cursor: pointer;" onclick="textarea_increase('wr_content', 5);"><img src="<?=$board_skin_path?>/img/down.gif"></span>&nbsp;<input type=checkbox id="wr_secret" name="wr_secret" value="secret">비밀글
