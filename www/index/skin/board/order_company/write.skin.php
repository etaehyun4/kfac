...
<tr>
    ...
    <td style='padding-left:5px;'><input class=my_input style="width:200;" name=wr_subject itemname="회사명"  value="<?=$subject?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#EEEEEE></td></tr>

<tr>
    <td bgcolor=#F9F9F9 style='padding-left:20px; height:30px;'>ㆍ담당부서</td>
    <td style='padding-left:5px;'><input class=my_input maxlength=30 size=35 name=wr_1 itemname="담당부서"  value="<?=$write[wr_1]?>"></td></tr>
...
<tr>
    <td bgcolor=#F9F9F9 style='padding-left:20px; height:30px;'>ㆍ이  름</td>
    <td style='padding-left:5px;'><input class=my_input maxlength=20 size=15 name=wr_name itemname="이름"  value="<?=$write[wr_name]?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#EEEEEE></td></tr>
<? } ?>
...
<input name='ext9_01' value='<?=$ext9_01?>' type='text' size='5' minlength='3' maxlength='4' itemname='전화 두번째자리' class='my_input' onkeydown='onlyNumber(this);'>  - 
<input name='ext9_02' value='<?=$ext9_02?>' type='text' size='5' minlength='4' maxlength='4' itemname='전화 세번째자리' class='my_input' onkeydown='onlyNumber(this);'> &nbsp; &nbsp;

ㆍHP :
<select name='ext9_03' class='my_input' required itemname='통신사'>
...
<input name='ext9_04' value='<?=$ext9_04?>' type='text' size='5' minlength='3' maxlength='4' itemname='휴대전화 두번째자리' class='my_input' onkeydown='onlyNumber(this);'>  - 
<input name='ext9_05' value='<?=$ext9_05?>' type='text' size='5' minlength='4' maxlength='4' itemname='휴대전화 세번째자리' class='my_input' onkeydown='onlyNumber(this);'>
</td>
</tr>
...
<tr>
    ...
    <td style='padding-left:5px;'>
        ...
        <? if ($is_dhtml_editor) { ?>
            <?//=cheditor2('fwrite', 'wr_content', '98%', '350');?>
        ...
        <textarea id="wr_content" name="wr_content" class=my_input style='width:98%; word-break:break-all;' rows=10 itemname="내용" required 
