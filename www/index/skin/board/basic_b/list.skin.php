...
<tr>
    ...
    <? if ($is_checkbox) { ?><td bgcolor="#333333"></td><?}?>
    <td bgcolor="#333333"></td>
    <? if ($is_name) { ?><td bgcolor="#CC0000"></td><?}?>
    <? if ($is_date) { ?><td bgcolor="#CC0000"></td><?}?>
    <td bgcolor="#CC0000"></td>
    <? if ($is_good) { ?><td bgcolor="#CC0000"></td><?}?>
    <? if ($is_good) { ?><td bgcolor="#CC0000"></td><?}?>
</tr>
...
<tr><td colspan=<?=$colspan?> bgcolor="#333333" height="2"></td></tr>
</table>
</form>
