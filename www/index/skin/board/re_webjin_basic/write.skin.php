...
<tr>
    <td class=write_head>웹진 일자/호</td>
    <td><input class='ed' Size=10 name="wr_1" id="wr_1" itemname="년도" required value="<?=$write["wr_1"]?>"> 일자 
	<input class='ed' Size=2 name="wr_2" id="wr_2" itemname="호" required value="<?=$write["wr_2"]?>"> 호 
	&nbsp;&nbsp;&nbsp;&nbsp;예) <FONT COLOR="#FF00FF"><B>2011-04-01</B></FONT>일자 <FONT COLOR="#FF00FF"><B>18</B></FONT>호,  * 같은 웹진 일자/호를 동일하게 입력.
	</td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
...
<tr>
    <td class=write_head>회사명/마감일</td>
    <td><input class='ed' Size=28 name="wr_3" id="wr_3" itemname="회사명"  value="<?=$write["wr_3"]?>"> 회사명 
	<input class='ed' Size=14 name="wr_4" id="wr_4" itemname="마감일" required value="<?=$write["wr_4"]?>"> 마감일 
	&nbsp;&nbsp;&nbsp;&nbsp;예) <FONT COLOR="#FF00FF"><B>(재)국립현대무용단</B></FONT>회사명 <FONT COLOR="#FF00FF"><B>2011-09-02</B></FONT>마감일
	</td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>

<? } else if ($bo_table == "re_webjin_10") { ?>

<tr>
    <td class=write_head>보도/기자</td>
    <td><input class='ed' Size=28 name="wr_3" id="wr_3" itemname="보도"  value="<?=$write["wr_3"]?>"> 보도 
	<input class='ed' Size=14 name="wr_4" id="wr_4" itemname="호" required value="<?=$write["wr_4"]?>"> 기자 
	&nbsp;&nbsp;&nbsp;&nbsp;예) <FONT COLOR="#FF00FF"><B>연합뉴스 2011.4.1 보도</B></FONT>보도 <FONT COLOR="#FF00FF"><B>홍길동 기자</B></FONT>기자
	</td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>


<? } else if ($bo_table == "re_webjin_02" || $bo_table == "re_webjin_03" || $bo_table == "re_webjin_04" || $bo_table == "re_webjin_05" || $bo_table == "re_webjin_07" || $bo_table == "re_webjin_08" || $bo_table == "re_webjin_12") { ?>

    <td class=write_head>작성자</td>
    <td><input class='ed' Size=52 name="wr_3" id="wr_3" itemname="작성자"  value="<?=$write["wr_3"]?>"> 작성자 
	&nbsp;&nbsp;&nbsp;&nbsp;예) <FONT COLOR="#FF00FF"><B>김채현 _ 본 협회 공동대표 / 무용원 교수 </B></font>
	</td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
...
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
    <td class=write_head>부제목</td>
    <td><input class='ed' style="width:100%;" name=wr_5 id="wr_5" itemname="부제목"  value="<?=$write["wr_5"]?>"></td></tr>
<tr><td colspan=2 height=1 bgcolor=#e7e7e7></td></tr>
<tr>
