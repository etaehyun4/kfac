...
<!--    <div style="float:left; margin-top:6px;">
	...
	<? if ($is_admin) {	echo "<a href=\"$list_href\"><img src='$board_skin_path/img/btn_list.gif' border='0' align='absmiddle'></a> ";  } ?>
...
<? if ($bo_table == "re_webjin_01" || $bo_table == "re_webjin_02" || $bo_table == "re_webjin_03" || $bo_table == "re_webjin_04" || $bo_table == "re_webjin_05"  || $bo_table == "re_webjin_07" || $bo_table == "re_webjin_08" || $bo_table == "re_webjin_11" || $bo_table == "re_webjin_12") { ?>
<div style="border:0px solid #ddd; clear:both; height:34px; repeat-x;">
    <table border=0 cellpadding=0 cellspacing=0 width=100%>
    <tr>
        <td style="padding:8px 0 0 10px;">
            <div style="color:#505050; font-family:바탕; font-size:19px; font-weight:bold; word-break:break-all;">
            | <?=cut_hangul_last(get_text($view[wr_subject]))?>
            </div>
        </td>
    </tr>
	    <tr>
        <td style="padding:8px 0 50 10px;">
            <div style="color:#505050; font-family:바탕; font-size:17px;  word-break:break-all;">
			　 <?=cut_hangul_last(get_text($view[wr_5]))?>
            </div>
        </td>
    </tr>
	<tr>
        <td align="right"style="padding:30px 35px 70px 0;">
            <div style="color:#505050; font-family:바탕; font-size:17px; font-weight:bold;  word-break:break-all;">
			<?=cut_hangul_last(get_text($view[wr_3]))?>
            </div>
        </td>
    </tr>
    </table>
