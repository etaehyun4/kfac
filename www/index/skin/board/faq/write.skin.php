...
<tr>
    ...
    <td><input class=ed type=password maxlength=20 size=15 name=wr_password itemname="비밀번호" <?=$password_required?>> ※ 수정/삭제시 필요합니다.</td></tr>
<tr><td colspan=2 height=1 bgcolor='<?=$linecolor_div?>'></td></tr>
<? } ?>
...
<? if ($is_file) { ?>
<tr>
    <td style='padding-left:20px; height:30px;'><table cellpadding=0 cellspacing=0><tr><td style=" padding-top: 10px;">· 파일 <span onclick="add_file();" style='cursor:pointer; font-family:굴림; font-size:10pt;'>+</span> <span onclick="del_file();" style='cursor:pointer; font-family:굴림; font-size:12pt;'>-</span></td></tr></table></td>
