...
<tr><td colspan=2>
    ...
    <? if ($is_guest) { ?>
        ...
        비밀번호 <INPUT type=password maxLength=20 size=15 name="wr_password" itemname="비밀번호" required class=ed>
            <? if ($is_norobot) { ?>
                <?=$norobot_str?>
    ...
    <span style="cursor: pointer;" onclick="textarea_decrease('wr_content', 10);"><img src="<?=$board_skin_path?>/img/up.gif" align=absmiddle></span>
    <span style="cursor: pointer;" onclick="textarea_original('wr_content', 10);"><img src="<?=$board_skin_path?>/img/start.gif" align=absmiddle></span>
    <span style="cursor: pointer;" onclick="textarea_increase('wr_content', 10);"><img src="<?=$board_skin_path?>/img/down.gif" align=absmiddle></span>
