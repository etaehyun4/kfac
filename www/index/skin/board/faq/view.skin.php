...
<tr><td height=2 bgcolor='<?=$linecolor_top?>'></td></tr> 
<tr><td height=30 bgcolor=#F8F8F9 style="padding:5 0 5 0;">&nbsp;&nbsp;<strong><? if ($is_category) { echo ($category_name ? "[$view[ca_name]] " : ""); } ?>제&nbsp;&nbsp;목 : <?=cut_hangul_last($view[wr_subject])?></strong></td></tr>
<tr><td height=1 bgcolor='<?=$linecolor_div?>'></td></tr>
...
<tr><td height=1 bgcolor='<?=$linecolor_div?>'></td></tr>
<tr> 
    <td height="150" style='word-break:break-all; padding:10px; border:1px solid #D9D9D9;' bgcolor=#F8F8F9>
        <? 
        // 파일 출력
        for ($i=0; $i<=count($view[file]); $i++) {
            if ($view[file][$i][view]) 
