    ...
    <td width="628" align="center" background="<?=$member_skin_path?>/img/login_table_bg.gif">
        ...
        <tr>
            <td width="460" height="223" align="center" bgcolor="#FFFFFF">
                ...
                <tr>
                    <td height="26" colspan="2"><img src="<?=$member_skin_path?>/img/icon.gif" width="3" height="3"> 아직 회원이 아니십니까?&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:;" onclick="window.open('./register.php','상세정보','width=750,height=790, scrollbars=yes')"><img width="72" height="20" src="<?=$member_skin_path?>/img/btn_register.gif" border=0 align="absmiddle"></a></td>
                </tr>
                <tr>
