    ...
    <td bgcolor="#FFFFFF">
        ...
        <TR bgcolor="#FFFFFF">
            ...
            <TD valign="middle" class=m_padding>
                ...
                <tr>
                    <td height="25" colspan="2"><input class=ed type=text name='mb_addr1' style='width:95%; readonly <?=$config[cf_req_addr]?'required':'';?> itemname='ÁÖ¼Ò' value='<?=$member[mb_addr1]?>'></td>
                </tr>
                <tr>
                    <td height="25" colspan="2"><input class=ed type=text name='mb_addr2' style='width:95%; <?=$config[cf_req_addr]?'required':'';?> itemname='»ó¼¼ÁÖ¼Ò' value='<?=$member[mb_addr2]?>'></td>
                </tr>
                </table>
            </TD>
        </TR>
