...
<table width=100% cellspacing=0 cellspacing=0 align=center><tr><td align=center>
    ...
    <tr> 
        <td align=center><img src="<?=$member_skin_path?>/img/join_title.gif" height="72"></td>
    </tr>
    </table>
    ...
    <table width="100%" cellpadding="4" cellspacing="0" bgcolor=#EEEEEE>
        ...
        <tr> 
            <td align="center" valign="top"><textarea style="width: 98%" rows=15 readonly class=ed><?=get_text($config[cf_stipulation])?></textarea></td>
        </tr>
        <tr> 
    ...
    <table width="100%" cellpadding="4" cellspacing="0" bgcolor=#EEEEEE>
        ...
        <tr> 
            <td align="center" valign="top"><textarea style="width: 98%" rows=15 readonly class=ed><?=get_text($config[cf_privacy])?></textarea></td>
        </tr>
        <tr> 
